 ...
 * example file, the filename is "cyberpanel" and therefore all functions
 * begin "addonmodule_".
 *
 ...
 * @return array
 */
function cyberpanel_config()
{
    return [
        // Display name for your module
        'name' => 'CyberPanel Partners Module',
        // Description displayed within the admin interface
        'description' => 'This plugin is for our partners who wants to offer CyberPanel add-ons on their WHMCS store. You will need a key from our platform, once registered to go "Reseller Center" from the main menu and you will be presented with the key.',
        // Module author name
        'author' => 'Usman Nasir',
        // Default language
        'language' => 'english',
        ...
        'fields' => [
            ...
            'Partner Key' => [
                'FriendlyName' => 'Partner Key',
                'Type' => 'text',
                'Size' => '255',
                'Default' => 'Default value',
                'Description' => 'Go to https://platform.cyberpersons.com to get the key.',
            ],
...
//            );
        ...
        return [
            ...
            'status' => 'success',
            'description' => 'Module activated, please get a key from https://platform.cyberpersons.com'
        ];
    } catch (\Exception $e) {
        return [
            // Supported values here include: success, error or info
 ...
 * @return array Optional success/failure message
 */
function cyberpanel_deactivate()
{
 ...
 * @return void
 */
function cyberpanel_upgrade($vars)
{
 ...
 * @return string
 */
function cyberpanel_output($vars)
{
    // Get common module parameters
    $modulelink = $vars['modulelink']; // eg. addonmodules.php?module=cyberpanel
 ...
 * @return string
 */
function cyberpanel_sidebar($vars)
{
    // Get common module parameters
 ...
 * @return array
 */
function cyberpanel_clientarea($vars)
{
    // Get common module parameters
    $modulelink = $vars['modulelink']; // eg. index.php?m=cyberpanel
    $version = $vars['version']; // eg. 1.0
    $_lang = $vars['_lang']; // an array of the currently loaded language variables
